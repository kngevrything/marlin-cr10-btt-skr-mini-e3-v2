...
#define STRING_CONFIG_H_AUTHOR "(Kevin Liedtke, CR10v3 BTT Mini SKR E3 V2.0)" // Who made the changes.
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 201.86
  #define DEFAULT_BED_KI 10.67
  #define DEFAULT_BED_KD 954.96
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.75, 79.75, 400.00, 403.90 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN PC15             // Pin to use for filament runout detection. Override the default pin here.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 150, 150, 20 }
